...
def reportearticulo(request):
    data ={
        'titulo':'Consulta de Productos',
        'model': 'Artículo',
        'ruta':'/compra/reportearticulo/',
    ...
    if request.method == 'POST':
        ...
        if 'sucursa' in request.GET:
            ...
            pdf = render_to_pdf('compra/reporteunidadordenproducto.html', articulo)
        ...
        return  render(request, 'compra/reporteproducto.html', data)

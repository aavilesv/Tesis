...
function sidebarType(e) {
    ...
    if (d.classList.add(a), "bg-white" == a) { var u = document.querySelectorAll(".sidenav .text-white"); for (let e = 0; e < u.length; e++) u[e].classList.remove("text-white"), u[e].classList.add("text-dark") } else { var g = document.querySelectorAll(".sidenav .text-dark"); for (let e = 0; e < g.length; e++) g[e].classList.add("text-white"), g[e].classList.remove("text-dark") }
    if ("bg-default" == a && i) { g = document.querySelectorAll(".navbar-brand .text-dark"); for (let e = 0; e < g.length; e++) g[e].classList.add("text-white"), g[e].classList.remove("text-dark") }
...
function toggleNavLinksColor(e) {
    ...
    "blur" === e ? (t.forEach(e => { e.classList.remove("text-body") }), a.forEach(e => { e.classList.add("bg-dark") })) : "transparent" === e && (t.forEach(e => { e.classList.add("text-body") }), a.forEach(e => { e.classList.remove("bg-dark") }))
}
...
function navbarBlurOnScroll(e) {
    ...
    function l() { t.classList.add(...n), t.classList.remove(...i), toggleNavLinksColor("blur") }

    function s() { t.classList.remove(...n), t.classList.add(...i), toggleNavLinksColor("transparent") }(5 < window.scrollY ? l : s)(), window.onscroll = debounce("true" == e ? function() {
        (5 < window.scrollY ? l : s)()
    } : function() { s() }, 10), -1 < navigator.platform.indexOf("Win") && (a = document.querySelector(".main-content"), "true" == e ? a.addEventListener("ps-scroll-y", debounce(function() {
        (5 < a.scrollTop ? l : s)()
    }, 10)) : a.addEventListener("ps-scroll-y", debounce(function() { s() }, 10)))
}
...
setTimeout(function() { initNavs() }, 100), window.addEventListener("resize", function(e) {
...
function navbarColorOnResize() { sidenav && (1200 < window.innerWidth ? referenceButtons.classList.contains("active") && "bg-transparent" === referenceButtons.getAttribute("data-class") ? sidenav.classList.remove("bg-white") : sidenav.classList.add("bg-white") : (sidenav.classList.add("bg-white"), sidenav.classList.remove("bg-transparent"))) }
...
var soft = {
        ...
        document.addEventListener("DOMContentLoaded", function() {
            var e = document.getElementById("fullCalendar"),
                ...
                i = new FullCalendar.Calendar(e, {
                    ...
                    select: function(a) {
                        Swal.fire({ title: "Create an Event", html: '<div class="form-group"><input class="form-control text-default" placeholder="Event Title" id="input-field"></div>', showCancelButton: !0, customClass: { confirmButton: "btn btn-primary", cancelButton: "btn btn-danger" }, buttonsStyling: !1 }).then(function(e) {
    ...
    showSwal: function(e) {
        if ("basic" == e) Swal.fire("Any fool can use a computer");
            ...
            n.fire({ title: "Are you sure?", text: "You won't be able to revert this!", icon: "warning", showCancelButton: !0, confirmButtonText: "Yes, delete it!" }).then(e => { e.isConfirmed && Swal.fire("Deleted!", "Your file has been deleted.", "success") })
